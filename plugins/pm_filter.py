...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/Film_Bee"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/Film_Bee")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/Film_Bee'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/Film_Bee')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Hub 🎬', url=f'https://t.me/+JDaygU-G-fc2YTE1')
            ]
            ]
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/+JDaygU-G-fc2YTE1')
            ]
            ]
        await query.answer()
        await client.send_cached_media(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/Film_Bee'),
            InlineKeyboardButton('Movie Hub ⭕️', url='https://t.me/+JDaygU-G-fc2YTE1')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/Film_Bee'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Movie Hub", url="https://t.me/+JDaygU-G-fc2YTE1"),
        InlineKeyboardButton("Series Hub ⭕️", url="https://t.me/+JDaygU-G-fc2YTE1")
    ])
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/Film_Bee")
    ])
